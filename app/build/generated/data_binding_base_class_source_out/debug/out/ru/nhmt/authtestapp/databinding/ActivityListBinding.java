...
public final class ActivityListBinding implements ViewBinding {
  ...
  private ActivityListBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView usersList) {
  ...
  public static ActivityListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityListBinding((ConstraintLayout) rootView, usersList);
    }
